...
**Board:** SolidWorks  
**Slot:** 3  
**Runtime key:** `cad_application_assist.tertiary.03`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating a SolidWorks feature tree plan**.

### Goal

Create a practical, bounded result for creating a SolidWorks feature tree plan.
