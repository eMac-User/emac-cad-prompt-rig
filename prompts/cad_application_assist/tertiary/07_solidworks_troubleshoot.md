# SolidWorks Troubleshoot

**Profile:** CAD Application Assist  
**Board:** SolidWorks  
**Slot:** 7  
**Runtime key:** `cad_application_assist.tertiary.07`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **troubleshooting SolidWorks issues**.

### Goal

Create a practical, bounded result for troubleshooting SolidWorks issues.
