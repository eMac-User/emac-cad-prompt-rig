# SolidWorks Relations

**Profile:** CAD Application Assist  
**Board:** SolidWorks  
**Slot:** 2  
**Runtime key:** `cad_application_assist.tertiary.02`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating SolidWorks sketch relations**.

### Goal

Create a practical, bounded result for creating SolidWorks sketch relations.
