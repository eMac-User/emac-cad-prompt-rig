# SolidWorks Assembly BOM

**Profile:** CAD Application Assist  
**Board:** SolidWorks  
**Slot:** 6  
**Runtime key:** `cad_application_assist.tertiary.06`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating SolidWorks assembly and BOM notes**.

### Goal

Create a practical, bounded result for creating SolidWorks assembly and BOM notes.
