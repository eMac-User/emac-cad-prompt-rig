# SolidWorks Holes Fillets

**Profile:** CAD Application Assist  
**Board:** SolidWorks  
**Slot:** 4  
**Runtime key:** `cad_application_assist.tertiary.04`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **adding holes, fillets, and chamfers in SolidWorks**.

### Goal

Create a practical, bounded result for adding holes, fillets, and chamfers in SolidWorks.
