...
**Board:** SolidWorks  
**Slot:** 1  
**Runtime key:** `cad_application_assist.tertiary.01`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating SolidWorks modeling steps**.

### Goal

Create a practical, bounded result for creating SolidWorks modeling steps.
