...
**Board:** SolidWorks  
**Slot:** 8  
**Runtime key:** `cad_application_assist.tertiary.08`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating a SolidWorks handoff prompt**.

### Goal

Create a practical, bounded result for creating a SolidWorks handoff prompt.
