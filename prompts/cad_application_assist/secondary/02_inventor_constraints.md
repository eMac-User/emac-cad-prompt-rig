...
**Slot:** 2  
**Runtime key:** `cad_application_assist.secondary.02`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating Inventor 2D sketch constraints**.

### Goal

Create a practical, bounded result for creating Inventor 2D sketch constraints.
