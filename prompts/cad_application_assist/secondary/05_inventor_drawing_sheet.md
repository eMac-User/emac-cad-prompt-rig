# Inventor Drawing Sheet

**Profile:** CAD Application Assist  
**Board:** Autodesk Inventor  
**Slot:** 5  
**Runtime key:** `cad_application_assist.secondary.05`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating an Inventor drawing sheet plan**.

### Goal

Create a practical, bounded result for creating an Inventor drawing sheet plan.
