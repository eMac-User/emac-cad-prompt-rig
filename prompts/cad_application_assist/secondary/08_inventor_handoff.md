...
**Slot:** 8  
**Runtime key:** `cad_application_assist.secondary.08`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating an Inventor handoff prompt**.

### Goal

Create a practical, bounded result for creating an Inventor handoff prompt.
