# Inventor Holes Fillets

**Profile:** CAD Application Assist  
**Board:** Autodesk Inventor  
**Slot:** 4  
**Runtime key:** `cad_application_assist.secondary.04`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **adding holes, fillets, and chamfers in Inventor**.

### Goal

Create a practical, bounded result for adding holes, fillets, and chamfers in Inventor.
