...
**Slot:** 1  
**Runtime key:** `cad_application_assist.secondary.01`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating Autodesk Inventor part steps**.

### Goal

Create a practical, bounded result for creating Autodesk Inventor part steps.
