# Inventor Assembly BOM

**Profile:** CAD Application Assist  
**Board:** Autodesk Inventor  
**Slot:** 6  
**Runtime key:** `cad_application_assist.secondary.06`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating assembly and BOM notes in Inventor**.

### Goal

Create a practical, bounded result for creating assembly and BOM notes in Inventor.
