...
**Slot:** 3  
**Runtime key:** `cad_application_assist.secondary.03`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating an Inventor extrusion and cut feature tree**.

### Goal

Create a practical, bounded result for creating an Inventor extrusion and cut feature tree.
