...
**Slot:** 3  
**Runtime key:** `cad_application_assist.primary.03`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating Fusion extrude and cut plans**.

### Goal

Create a practical, bounded result for creating Fusion extrude and cut plans.
