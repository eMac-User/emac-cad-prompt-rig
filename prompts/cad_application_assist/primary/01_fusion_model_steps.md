...
**Slot:** 1  
**Runtime key:** `cad_application_assist.primary.01`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating Autodesk Fusion modeling steps**.

### Goal

Create a practical, bounded result for creating Autodesk Fusion modeling steps.
