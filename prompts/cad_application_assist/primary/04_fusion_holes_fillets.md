# Fusion Holes Fillets

**Profile:** CAD Application Assist  
**Board:** Autodesk Fusion  
**Slot:** 4  
**Runtime key:** `cad_application_assist.primary.04`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **adding holes, fillets, and chamfers in Fusion**.

### Goal

Create a practical, bounded result for adding holes, fillets, and chamfers in Fusion.
