...
**Slot:** 2  
**Runtime key:** `cad_application_assist.primary.02`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating Fusion sketch constraints**.

### Goal

Create a practical, bounded result for creating Fusion sketch constraints.
