...
**Slot:** 7  
**Runtime key:** `cad_application_assist.primary.07`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **troubleshooting Fusion feature failures**.

### Goal

Create a practical, bounded result for troubleshooting Fusion feature failures.
