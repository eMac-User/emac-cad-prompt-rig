...
**Slot:** 5  
**Runtime key:** `cad_application_assist.primary.05`

## Prompt

You are helping with **CAD Application Assist** work. Use this prompt slot for **creating Fusion drawing views**.

### Goal

Create a practical, bounded result for creating Fusion drawing views.
