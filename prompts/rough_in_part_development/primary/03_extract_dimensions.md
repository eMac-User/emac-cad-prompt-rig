...
**Slot:** 3  
**Runtime key:** `rough_in_part_development.primary.03`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **extracting dimensions and constraints from rough material**.

### Goal

Create a practical, bounded result for extracting dimensions and constraints from rough material.
