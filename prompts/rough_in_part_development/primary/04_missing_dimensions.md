...
**Board:** Rough-In Intake  
**Slot:** 4  
**Runtime key:** `rough_in_part_development.primary.04`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **identifying the smallest missing dimensions needed for the next design step**.

### Goal

Create a practical, bounded result for identifying the smallest missing dimensions needed for the next design step.
