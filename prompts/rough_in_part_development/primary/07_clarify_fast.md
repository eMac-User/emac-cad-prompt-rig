...
**Slot:** 7  
**Runtime key:** `rough_in_part_development.primary.07`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **asking minimum useful clarifying questions**.

### Goal

Create a practical, bounded result for asking minimum useful clarifying questions.
