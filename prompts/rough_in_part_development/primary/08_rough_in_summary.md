...
**Slot:** 8  
**Runtime key:** `rough_in_part_development.primary.08`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **creating a concise rough-in summary for the next board**.

### Goal

Create a practical, bounded result for creating a concise rough-in summary for the next board.
