...
**Slot:** 6  
**Runtime key:** `rough_in_part_development.primary.06`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **spotting manufacturability issues in a rough concept**.

### Goal

Create a practical, bounded result for spotting manufacturability issues in a rough concept.
