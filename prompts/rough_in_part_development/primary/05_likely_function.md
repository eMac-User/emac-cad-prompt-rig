...
**Slot:** 5  
**Runtime key:** `rough_in_part_development.primary.05`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **inferring likely part function while labeling assumptions**.

### Goal

Create a practical, bounded result for inferring likely part function while labeling assumptions.
