...
**Slot:** 2  
**Runtime key:** `rough_in_part_development.secondary.02`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **straightening and squaring rough layout geometry**.

### Goal

Create a practical, bounded result for straightening and squaring rough layout geometry.
