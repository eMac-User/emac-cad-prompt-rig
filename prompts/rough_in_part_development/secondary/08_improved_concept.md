...
**Slot:** 8  
**Runtime key:** `rough_in_part_development.secondary.08`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **creating an improved part concept from rough input**.

### Goal

Create a practical, bounded result for creating an improved part concept from rough input.
