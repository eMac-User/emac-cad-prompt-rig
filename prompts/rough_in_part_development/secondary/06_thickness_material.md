...
**Slot:** 6  
**Runtime key:** `rough_in_part_development.secondary.06`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **suggesting thickness and material assumptions**.

### Goal

Create a practical, bounded result for suggesting thickness and material assumptions.
