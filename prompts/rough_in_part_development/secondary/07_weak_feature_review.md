...
**Slot:** 7  
**Runtime key:** `rough_in_part_development.secondary.07`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **identifying weak or awkward mechanical features**.

### Goal

Create a practical, bounded result for identifying weak or awkward mechanical features.
