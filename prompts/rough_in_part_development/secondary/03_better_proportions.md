...
**Slot:** 3  
**Runtime key:** `rough_in_part_development.secondary.03`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **suggesting better mechanical proportions**.

### Goal

Create a practical, bounded result for suggesting better mechanical proportions.
