...
**Slot:** 4  
**Runtime key:** `rough_in_part_development.secondary.04`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **recommending hole and slot placement**.

### Goal

Create a practical, bounded result for recommending hole and slot placement.
