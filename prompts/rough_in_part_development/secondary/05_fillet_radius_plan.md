...
**Slot:** 5  
**Runtime key:** `rough_in_part_development.secondary.05`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **planning fillets, chamfers, and radii**.

### Goal

Create a practical, bounded result for planning fillets, chamfers, and radii.
