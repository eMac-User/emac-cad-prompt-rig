...
**Slot:** 5  
**Runtime key:** `rough_in_part_development.tertiary.05`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **identifying ribs, tabs, brackets, bosses, and supports**.

### Goal

Create a practical, bounded result for identifying ribs, tabs, brackets, bosses, and supports.
