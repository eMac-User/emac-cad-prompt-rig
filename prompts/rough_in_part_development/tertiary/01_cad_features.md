...
**Slot:** 1  
**Runtime key:** `rough_in_part_development.tertiary.01`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **breaking the part into CAD model features**.

### Goal

Create a practical, bounded result for breaking the part into CAD model features.
