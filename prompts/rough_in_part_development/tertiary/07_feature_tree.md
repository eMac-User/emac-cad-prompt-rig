...
**Slot:** 7  
**Runtime key:** `rough_in_part_development.tertiary.07`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **drafting a feature tree for CAD modeling**.

### Goal

Create a practical, bounded result for drafting a feature tree for CAD modeling.
