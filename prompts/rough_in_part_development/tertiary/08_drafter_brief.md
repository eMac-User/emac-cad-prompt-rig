...
**Slot:** 8  
**Runtime key:** `rough_in_part_development.tertiary.08`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **creating a drafter-ready rough brief**.

### Goal

Create a practical, bounded result for creating a drafter-ready rough brief.
