...
**Slot:** 4  
**Runtime key:** `rough_in_part_development.tertiary.04`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **identifying holes, countersinks, counterbores, and related features**.

### Goal

Create a practical, bounded result for identifying holes, countersinks, counterbores, and related features.
