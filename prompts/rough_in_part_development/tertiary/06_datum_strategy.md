...
**Slot:** 6  
**Runtime key:** `rough_in_part_development.tertiary.06`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **choosing symmetry, origin, and datum strategy**.

### Goal

Create a practical, bounded result for choosing symmetry, origin, and datum strategy.
