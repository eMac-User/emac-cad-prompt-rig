...
**Slot:** 2  
**Runtime key:** `rough_in_part_development.tertiary.02`

## Prompt

You are helping with **Rough-In / Part Development** work. Use this prompt slot for **identifying the best base body strategy**.

### Goal

Create a practical, bounded result for identifying the best base body strategy.
