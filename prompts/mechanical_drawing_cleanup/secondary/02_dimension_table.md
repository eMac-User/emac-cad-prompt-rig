...
**Slot:** 2  
**Runtime key:** `mechanical_drawing_cleanup.secondary.02`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **creating a dimension table**.

### Goal

Create a practical, bounded result for creating a dimension table.
