...
**Slot:** 7  
**Runtime key:** `mechanical_drawing_cleanup.secondary.07`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **defining radii, fillets, and chamfers**.

### Goal

Create a practical, bounded result for defining radii, fillets, and chamfers.
