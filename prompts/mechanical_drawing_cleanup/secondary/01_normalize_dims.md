...
**Slot:** 1  
**Runtime key:** `mechanical_drawing_cleanup.secondary.01`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **normalizing dimensions into a clean dimensioning plan**.

### Goal

Create a practical, bounded result for normalizing dimensions into a clean dimensioning plan.
