...
**Slot:** 5  
**Runtime key:** `mechanical_drawing_cleanup.secondary.05`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **defining datum and reference edges**.

### Goal

Create a practical, bounded result for defining datum and reference edges.
