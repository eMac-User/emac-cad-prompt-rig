...
**Slot:** 3  
**Runtime key:** `mechanical_drawing_cleanup.secondary.03`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **flagging dimension conflicts and ambiguity**.

### Goal

Create a practical, bounded result for flagging dimension conflicts and ambiguity.
