...
**Slot:** 6  
**Runtime key:** `mechanical_drawing_cleanup.secondary.06`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **defining hole-center dimensions**.

### Goal

Create a practical, bounded result for defining hole-center dimensions.
