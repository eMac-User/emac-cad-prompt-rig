...
**Slot:** 4  
**Runtime key:** `mechanical_drawing_cleanup.secondary.04`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **adding missing dimension callout recommendations**.

### Goal

Create a practical, bounded result for adding missing dimension callout recommendations.
