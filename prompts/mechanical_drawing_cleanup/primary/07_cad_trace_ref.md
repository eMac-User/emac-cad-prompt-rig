...
**Slot:** 7  
**Runtime key:** `mechanical_drawing_cleanup.primary.07`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **creating a CAD tracing reference prompt**.

### Goal

Create a practical, bounded result for creating a CAD tracing reference prompt.
