...
**Slot:** 3  
**Runtime key:** `mechanical_drawing_cleanup.primary.03`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **creating top and side view prompts**.

### Goal

Create a practical, bounded result for creating top and side view prompts.
