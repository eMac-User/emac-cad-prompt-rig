...
**Slot:** 4  
**Runtime key:** `mechanical_drawing_cleanup.primary.04`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **creating exploded or detail view prompts**.

### Goal

Create a practical, bounded result for creating exploded or detail view prompts.
