...
**Slot:** 8  
**Runtime key:** `mechanical_drawing_cleanup.primary.08`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **assembling a final mechanical image-generation prompt**.

### Goal

Create a practical, bounded result for assembling a final mechanical image-generation prompt.
