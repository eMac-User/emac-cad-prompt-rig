...
**Board:** Clean Mechanical Image Prompt  
**Slot:** 2  
**Runtime key:** `mechanical_drawing_cleanup.primary.02`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **converting the concept into an orthographic front view prompt**.

### Goal

Create a practical, bounded result for converting the concept into an orthographic front view prompt.
