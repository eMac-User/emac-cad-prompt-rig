...
**Slot:** 5  
**Runtime key:** `mechanical_drawing_cleanup.primary.05`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **creating a black-and-white line drawing prompt**.

### Goal

Create a practical, bounded result for creating a black-and-white line drawing prompt.
