...
**Slot:** 6  
**Runtime key:** `mechanical_drawing_cleanup.primary.06`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **creating patent-style line art instructions**.

### Goal

Create a practical, bounded result for creating patent-style line art instructions.
