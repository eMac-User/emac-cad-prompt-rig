...
**Slot:** 3  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.03`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **checking over-dimensioning**.

### Goal

Create a practical, bounded result for checking over-dimensioning.
