...
**Board:** Drawing Quality Review  
**Slot:** 7  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.07`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **checking whether the drawing can be modeled in CAD**.

### Goal

Create a practical, bounded result for checking whether the drawing can be modeled in CAD.
