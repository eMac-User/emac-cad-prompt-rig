...
**Slot:** 8  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.08`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **creating a drawing cleanup checklist**.

### Goal

Create a practical, bounded result for creating a drawing cleanup checklist.
