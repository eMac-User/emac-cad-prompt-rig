...
**Slot:** 6  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.06`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **checking line weight and labels**.

### Goal

Create a practical, bounded result for checking line weight and labels.
