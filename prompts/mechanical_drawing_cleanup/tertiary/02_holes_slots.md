...
**Slot:** 2  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.02`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **checking unclear holes and slots**.

### Goal

Create a practical, bounded result for checking unclear holes and slots.
