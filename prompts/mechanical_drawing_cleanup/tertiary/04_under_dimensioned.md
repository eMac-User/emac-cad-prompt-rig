...
**Slot:** 4  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.04`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **checking under-dimensioning**.

### Goal

Create a practical, bounded result for checking under-dimensioning.
