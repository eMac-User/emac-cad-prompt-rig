...
**Slot:** 5  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.05`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **checking part silhouette clarity**.

### Goal

Create a practical, bounded result for checking part silhouette clarity.
