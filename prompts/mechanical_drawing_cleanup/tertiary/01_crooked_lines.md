...
**Slot:** 1  
**Runtime key:** `mechanical_drawing_cleanup.tertiary.01`

## Prompt

You are helping with **Mechanical Drawing Cleanup** work. Use this prompt slot for **checking crooked or ambiguous lines**.

### Goal

Create a practical, bounded result for checking crooked or ambiguous lines.
